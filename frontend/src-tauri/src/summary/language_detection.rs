...
mod tests {
    ...
    fn transcript_summary_language_detects_chinese() {
        let texts = strings(&[
            "\u{56e2}\u{961f}\u{8ba8}\u{8bba}\u{4e86}\u{4ea7}\u{54c1}\u{8def}\u{7ebf}\u{56fe}\u{3001}\u{53d1}\u{5e03}\u{98ce}\u{9669}\u{4ee5}\u{53ca}\u{4e0b}\u{4e00}\u{9636}\u{6bb5}\u{7684}\u{5de5}\u{7a0b}\u{8ba1}\u{5212}\u{ff0c}\u{5e76}\u{786e}\u{8ba4}\u{4e86}\u{540e}\u{7eed}\u{8d1f}\u{8d23}\u{4eba}\u{3002}",
        ]);
