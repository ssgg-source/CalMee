    ...
    builder
        ...
        .setup(|_app| {
            ...
            if let Err(error) = tauri::async_runtime::block_on(async {
                ...
                // A migration or filesystem problem should never abort the macOS
                // application lifecycle callback. Keep the window alive so the UI
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // FunASR engine commands
            funasr_engine::funasr_init,
            funasr_engine::funasr_get_config,
            funasr_engine::funasr_save_config,
            ...
            transcript_refinement::api_cancel_transcript_refinement,
            transcript_refinement::api_get_saved_transcript_refinement,
            transcript_refinement::api_update_transcript_refinement_text,
            transcript_refinement::api_batch_update_transcript_refinement_text,
            // CalMee knowledge layer: meeting records, people/voiceprints and hotwords
            knowledge::api_get_or_build_meeting_record,
            knowledge::api_rebuild_meeting_record,
            knowledge::api_ai_organize_meeting_record,
            knowledge::api_start_ai_organize_meeting_record,
            knowledge::api_get_ai_organize_meeting_record_status,
            knowledge::api_cancel_ai_organize_meeting_record,
            knowledge::api_clear_ai_organize_meeting_record,
            knowledge::api_start_speech_summary,
            knowledge::api_get_speech_summary_status,
            knowledge::api_cancel_speech_summary,
            knowledge::api_clear_speech_summary,
            knowledge::api_get_smart_record_harness,
            knowledge::api_save_smart_record_harness,
            knowledge::api_reset_smart_record_harness,
            knowledge::api_apply_ai_meeting_record,
            knowledge::api_get_meeting_record_block_sources,
            knowledge::api_update_meeting_record_block,
            knowledge::api_update_meeting_record_document,
            knowledge::api_assign_meeting_record_block_person,
            knowledge::api_list_transcript_speaker_overrides,
            knowledge::api_set_transcript_speaker_override,
            knowledge::api_set_transcript_speaker_overrides,
            knowledge::api_update_transcript_text,
            knowledge::api_merge_meeting_record_block_with_next,
            knowledge::api_split_meeting_record_block,
            knowledge::api_list_people,
            knowledge::api_get_person_detail,
            knowledge::api_generate_person_profile,
            knowledge::api_get_person_profile_status,
            knowledge::api_cancel_person_profile,
            knowledge::api_create_person,
            knowledge::api_update_person,
            knowledge::api_update_person_profile,
            knowledge::api_delete_person,
            knowledge::api_assign_meeting_speaker,
            knowledge::api_list_hotwords,
            knowledge::api_upsert_hotword,
            knowledge::api_set_hotwords_enabled,
            knowledge::api_set_hotwords_category,
            knowledge::api_set_hotwords_tags,
            knowledge::api_delete_hotwords,
            knowledge::api_import_hotwords,
            calendar_integration::api_get_calendar_settings,
            calendar_integration::api_save_calendar_settings,
            calendar_integration::api_get_calendar_events,
            calendar_integration::api_get_calendar_collections,
            calendar_integration::api_set_calendar_enabled,
            calendar_integration::api_save_calendar_event,
            ...
            meeting_workspace::api_create_meeting_tag,
            meeting_workspace::api_update_meeting_tag,
            meeting_workspace::api_delete_meeting_tag,
            meeting_workspace::api_set_meeting_tag,
            meeting_workspace::api_list_document_templates,
            meeting_workspace::api_save_document_template,
            meeting_workspace::api_delete_document_template,
            meeting_workspace::api_get_generation_preference,
            ...
            audio::recording_commands::prepare_transcription_model,
            audio::recording_commands::set_live_caption_enabled,
            ...
            cloud_models::get_china_cloud_models,
            ...
            audio::retranscription::get_transcript_version_command,
            audio::retranscription::get_speaker_recluster_status_command,
            audio::retranscription::prepare_recording_speaker_diarization_command,
            audio::retranscription::recluster_meeting_speakers_command,
            audio::retranscription::cancel_speaker_recluster_command,
