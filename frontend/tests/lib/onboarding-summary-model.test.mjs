...
assert.equal(getSummaryModelSizeMb('qwen3.5:0.8b'), 508);
assert.equal(getSummaryModelSizeMb('qwen3.5:9b'), 5417);
...
assert.equal(getSummaryModelSizeLabel('qwen3.5:0.8b'), '~508 MiB');
assert.equal(getSummaryModelSizeLabel('qwen3.5:9b'), '~5.3 GiB');
