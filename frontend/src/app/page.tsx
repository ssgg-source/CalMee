...
import { Brain, CalendarCheck2, Check, ChevronRight, Clock3, FileText, Link2, Mic2, NotebookPen, Search, SlidersHorizontal, Trash2, Unlink, X } from 'lucide-react';
