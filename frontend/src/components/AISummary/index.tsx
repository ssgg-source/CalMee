...
export const AISummary = ({ summary, status, error, onSummaryChange, onRegenerateSummary, meeting }: Props) => {
  ...
  const convertToMarkdown = () => {
    ...
    const meetingDate = meeting?.meeting_start_time || meeting?.created_at;
    markdown += `## Date: ${meetingDate ? new Date(meetingDate).toLocaleDateString() : new Date().toLocaleDateString()}\n\n`;
