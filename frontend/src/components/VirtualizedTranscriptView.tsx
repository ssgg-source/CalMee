...
export const VirtualizedTranscriptView: React.FC<VirtualizedTranscriptViewProps> = ({
    ...
    return (
        <div ref={scrollRef} className="flex h-full min-h-0 flex-col overflow-y-scroll px-4 py-2 [scrollbar-gutter:stable]">
                    ...
                    {isRecording ? (
                        <>
                            ...
                            <p className="text-sm text-gray-600">
                                {isPaused ? lt('Recording paused') : lt('Listening for speech...')}
                            </p>
                            <p className="text-xs mt-1 text-gray-400">
                                {isPaused ? lt('Click resume to continue recording') : lt('Speak to see live transcription')}
                            </p>
                        </>
                    ) : (
                        <>
                            <p className="text-lg font-semibold">{lt('Welcome to CalMee!')}</p>
                            <p className="text-xs mt-1">{lt('Start recording to see live transcription')}</p>
                        </>
                    )}
                </motion.div>
            ) : useVirtualization ? (
