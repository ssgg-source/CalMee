...
export function SetupOverviewStep() {
  ...
  return (
    <OnboardingContainer
      ...
      description="CalMee requires that you download the Transcription & Summarization AI models for the software to work."
      step={2}
      ...
      <div className="flex flex-col items-center space-y-10">
        ...
        <div className="w-full max-w-xs space-y-4">
          ...
          <p className="text-center text-xs text-gray-500">
            CalMee is currently a development build.
          </p>
        </div>
      </div>
    </OnboardingContainer>
