...
// CalMee updates stay disabled until an independent signed release channel exists. Enable only after
// CalMee has its own signed release feed and public key.
export const CALMEE_UPDATE_CHANNEL_ENABLED = false;
...
export class UpdateService {
  ...
  async checkForUpdates(force = false): Promise<UpdateInfo> {
    if (!CALMEE_UPDATE_CHANNEL_ENABLED) {
