...
export function useAutoScroll({
    ...
    useEffect(() => {
        ...
        // Only scroll if new segments arrived and follow mode was enabled before
        // the DOM grew. Checking the new scrollHeight here incorrectly treats
        // every appended sentence as a manual scroll-away.
