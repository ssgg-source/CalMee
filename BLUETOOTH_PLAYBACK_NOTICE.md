...
When **reviewing recordings** in CalMee, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **CalMee records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing CalMee recordings** - Use wired/speakers instead
...
### This is Not a CalMee Bug

The issue is in **macOS's Bluetooth audio stack**, not in CalMee's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a CalMee bug. We've correctly recorded at 48kHz.
...
**A**: Yes! CalMee now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: CalMee v0.0.5+ on macOS
