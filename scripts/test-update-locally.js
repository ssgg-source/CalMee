...
console.log('=========================================');
console.log('  CalMee Update Testing Server');
console.log('=========================================\n');
...
server.listen(PORT, () => {
  ...
  console.log('⚠️  IMPORTANT: Remove the local endpoint after testing.');
  console.log('   Do not enable production updates until CalMee has its own signed release channel.\n');
